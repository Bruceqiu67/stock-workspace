...
- `references/robotics-value-chain.md` — A-share robotics/humanoid-robot value-chain map: 15 key stocks across 7 supply-chain layers (减速器,丝杠/轴承,力矩传感器,电子皮肤,伺服电机,3D视觉,关节模组). Includes Sina Finance API access patterns, sector crash-day behaviour, and industry catalysts as of 2026-07.
